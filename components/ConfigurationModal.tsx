...
CREATE TABLE IF NOT EXISTS public.admin_tasks (id text PRIMARY KEY, user_id uuid NOT NULL, task text NOT NULL, due_date timestamptz NOT NULL, completed boolean DEFAULT false, importance text DEFAULT 'normal', assignee text, location text, image_url text, audio_note text, order_index integer, updated_at timestamptz DEFAULT now());
